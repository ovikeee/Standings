...
<form action="">
    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0" style="width: 700px">
        ...
        <tr>
            ...
            <td style="text-align: center;"><select name="stage" id="stageId">
                <option value="1">финал</option>
                <option value="2">1/2</option>
                <option value="4">1/4</option>
                <option value="8">1/8</option>
            </select></td>
            <td style="text-align: center;"><select name="date" id="dateId">
                <option value="1">02-04-2014 23:37:50</option>
                <option value="2">02-04-2014 23:37:50</option>
            </select></td>
            <td style="text-align: center;"><select name="owner" id="ownerId">
                <option value="1">Анжи</option>
                <option value="2">2</option>
                <option value="3">3</option>
                <option value="4">Спартак</option>
                <option selected="selected" value="0"></option>
            </select></td>
            <td style="text-align: center;"><select name="guests" id="guestsId">
                <option value="1">Анжи</option>
                <option value="2">2</option>
                <option value="3">3</option>
                <option value="4">Спартак</option>
            ...
            <td style="text-align: center;"><select name="status" id="statusId">
                <option value="1">завершен</option>
                <option value="2">ожидается</option>
                <option value="3">отменен</option>
                <option value="4">тех. поражение</option>
            </select></td>
        </tr>
        </tbody>
    </table>
    <p align="center"><input name="add" type="button" onclick="addMatch()" value="Добавить матч"> <input name="edit"
                                                                                                         type="button"
                                                                                                         value="Изменить">
    </p>
    ...
    <table align="center" border="1" cellpadding="0" cellspacing="0" style="width: 700px">
        <caption><input maxlength="24" name="find" size="25" type="text"> <select name="param">
            <option value="1">id матча</option>
            <option value="2">стадия</option>
            <option value="3">дата</option>
            <option value="4">команда</option>
            <option value="5">статус матча</option>
            <option selected="selected" value="0">id турнира</option>
        </select> <input name="find" type="button" value="Найти"><br>
            <br>
            <p  id="textInfo">Список всех матчей</p>
        </caption>
        <thead>
        <tr>
            <th scope="col">id матча</th>
